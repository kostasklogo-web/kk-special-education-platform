...
export const CC_THERAPIST_COL_DEFAULT = 60;
...
export const CC_TIME_RULER_45_W = 36;
export const CC_TIME_RULER_50_W = 30;
export const CC_TIME_RULERS_TOTAL_W = CC_TIME_RULER_45_W + CC_TIME_RULER_50_W;

export const CC_RULER_HEADER_PX = 16;
export const CC_BOARD_CAPTION_PX = 14;

export const CC_CELL_COLUMN_PAD = 2;
export const CC_CELL_GAP_H = 2;
export const CC_CELL_INSET_V = 1;
/** Extra vertical separation between stacked cells in one column. */
export const CC_CELL_SLOT_GAP_V = 3;
