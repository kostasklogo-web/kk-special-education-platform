...
const ACTIONS = [
  ...
  { href: "/reports", label: "Αναφορές", icon: FileText },
    ...
    <div className="rounded-2xl border border-clinical-100/70 bg-gradient-to-r from-white via-clinical-50/25 to-white p-4 shadow-shell sm:p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm text-ink-muted">Ρεσεψιόν, θεραπευτές και διοίκηση — λιγότερα κλικ για την καθημερινή ροή.</p>
        </div>
        <Link
          href="/children/new"
          className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-clinical-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-clinical-700 min-h-[44px]"
        >
