...
export function KpiStatCard({ label, value, helper, icon: Icon, emphasis }: KpiStatCardProps) {
  return (
    <div
      className={[
        "relative overflow-hidden rounded-2xl border p-5 shadow-shell transition-shadow hover:shadow-md",
        emphasis
    ...
    >
      ...
      <p className="mt-2 text-sm leading-snug text-ink-muted">{helper}</p>
    </div>
  );
}
